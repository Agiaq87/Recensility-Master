...
if ( isset( $_POST['submit'] ) ){
    ...
    print_r($_POST);
    if ( isset($_POST['recensility_fastlink_id']) ){
        $F->update(
                $_POST['recensility_fastlink_index'],
                $_POST['recensility_fastlink_id'],
                $_POST['recensility_fastlink_name'],
                $_POST['recensility_fastlink_icon'],
                $_POST['recensility_fastlink_url']
                );
...
if ( isset($_POST['delete']) ){
   print_r($_POST);
   if ( isset($_POST['recensility_fastlink_id']) ){
       $F->delete($_POST['recensility_fastlink_index'], $_POST['recensility_fastlink_id']);
       var_dump($F->getFastLinks(ALL));
   }
}

    wp_verify_nonce('recensility-master-fastlink', 'recensility-master-field');
?>
                    ...
                    <?php wp_nonce_field('recensility-master-setting', 'recensility-master-field'); ?>                        
                        <div class="recensility-system-form-grid-container">
                            ...
                            <div class="recensility-system-body-grid-container-rows-item">
                                <input
                                    type="text"
                                    id="recensility_fastlink_name"
                                    name="recensility_fastlink_name"
                            ...
                            <div class="recensility-system-body-grid-container-rows-item">
                                <input
                                    type="text"
                                    id="recensility_fastlink_icon"
                                    name="recensility_fastlink_icon"
                            ...
                            <div class="recensility-system-body-grid-container-rows-item">
                                <input
                                    type="text"
                                    id="recensility_fastlink_url"
                                    name="recensility_fastlink_url"
                                    value="URL Fast Link"
                                >
                            </div>
                            <div class="recensility-system-body-grid-container-rows-item"></div>
                            ...
                            <div class="recensility-system-body-grid-container-rows-item">
                                <input type="submit" name="insert" value="Aggiungi" class="recensility-system-body-submit">
                            </div>
                            <div class="recensility-system-body-grid-container-rows-item"></div>
                        </div>
                </form> 
                            ...
                            while( $index < $F->getLength() ){
                                echo '
                                    <tr>
                                        ...
                                        <td><strong><center>'.$F->getLinkName($index).'</center></strong></td>
                                        <td><center><i class="'.$F->getIconClass($index).'"></i></center></td>
                                        <td>'.dateTransform( substr($F->getDate($index), 5, 6) ).'</td>
                                        <td>'.titleTransform($F->getURL($index), 35).'</td> 
                                        <td>
                                            <center>
                                                <a ';
                                                RM_a_i_modal(
                        ...
                        <div class="recensility-system-form-grid-container">
                            ...
                            <div class="recensility-system-body-grid-container-rows-item">
                                <input
                                    ...
                                    id="recensility_fastlink_name"
                                    name="recensility_fastlink_name"
                                    value="<?php echo $F->getLinkName($index) ?>"
                                >
                            </div>
                            <div class="recensility-system-body-grid-container-rows-item"></div>
                            ...
                            <div class="recensility-system-body-grid-container-rows-item">
                                <input
                                    ...
                                    id="recensility_fastlink_icon"
                                    name="recensility_fastlink_icon"
                                    value="<?php echo $F->getIconClass($index) ?>"
                                >
                            </div>
                            <div class="recensility-system-body-grid-container-rows-item"></div>
                            ...
                            <div class="recensility-system-body-grid-container-rows-item recensility-system-special-settings">Salvare le nuove impostazioni?</div>
                                <input 
                                    type="hidden" 
                                    value="<?php echo $F->getID($index); ?>"
                                    id="recensility_fastlink_id"
                                    name="recensility_fastlink_id">
                                <input 
                                    type="hidden" 
                                    value="<?php echo $index; ?>"
                                    id="recensility_fastlink_index"
                                    name="recensility_fastlink_index">
                            <div class="recensility-system-body-grid-container-rows-item">
                    ...
                    <?php wp_nonce_field('recensility-master-setting', 'recensility-master-field'); ?>                        
                        <div class="recensility-system-form-grid-container">
                            <div class="recensility-system-body-grid-container-rows-item recensility-system-special-settings">
                                Desideri eliminare il Fast Link "<strong><?php echo $F->getLinkName($index) ?></strong>"?
                                <input 
                                    type="hidden" 
                                    value="<?php echo $F->getID($index); ?>"
                                    id="recensility_fastlink_id"
